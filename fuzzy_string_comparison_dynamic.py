...
match_on_attribute3     = False  # set to true if you want to also match on attribute3
fix_sponsor_names       = False # set to true if you're matching to a list of DAF sponsors
output_file_term        = "2023_c3flows_with_nulls"
...
targets_file = os.path.join(work_dir, f"fuzzy_targets - c3 flows 2023_prepped.csv")
...
match_candidates_file = os.path.join(work_dir, f"fuzzy_match_candidates - c3 flows part ii 2023_prepped.csv")
